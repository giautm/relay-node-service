...
func (ec *executionContext) _Query_node(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalONode2giautmᚗdevᚋrelayᚑnodeᚑserviceᚋgraphᚋmodelᚐNode(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_nodes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]model.Node)
	fc.Result = res
	return ec.marshalNNode2ᚕgiautmᚗdevᚋrelayᚑnodeᚑserviceᚋgraphᚋmodelᚐNode(ctx, field.Selections, res)
}
...
var documentImplementors = []string{"Document", "_Entity", "Node"}
...
var todoImplementors = []string{"Todo", "_Entity", "Node"}
...
func (ec *executionContext) marshalNNode2ᚕgiautmᚗdevᚋrelayᚑnodeᚑserviceᚋgraphᚋmodelᚐNode(ctx context.Context, sel ast.SelectionSet, v []model.Node) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalONode2giautmᚗdevᚋrelayᚑnodeᚑserviceᚋgraphᚋmodelᚐNode(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalONode2giautmᚗdevᚋrelayᚑnodeᚑserviceᚋgraphᚋmodelᚐNode(ctx context.Context, sel ast.SelectionSet, v model.Node) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
